...
public class AudioManager : MonoBehaviour
{
    ...
    public AudioSource PlayRandomResource(string resource_name, IntRange numbers = null, float volume = .3f, FloatRange pitch = null)
    {
        ...
        return PlayResource(resource_name + clip_num.ToString(), volume, pitch);
    }
